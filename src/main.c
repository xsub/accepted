...
if accepted +y +Y +yes +YES -"no I dont want it" +IC"yes i want it" $answer ; 
then #do_some_stuff; fi

This will accept strings: "y", "Y", "yes", "YES", "yes i want it" and make 
program exit with code 0, meaning the user input was accepted; 

Any other string including empty string (default behaviour) 
makes program exit with 1, in example above we explicitly add "no I dont want 
it" to negative answers. 

The +IC prefix to +IC"yes i want it" command line argument "Ignores Case" for this string, meaning any combination of lower and upper case letters is allowed.
